...
class DirectionTree:
    def __init__(self,
                 direction_name: str = 'rkv_i2c_tb',
                 direction_path: str = 'D:\\Amaster\\A路科课程\\路科验证_V2课程资料\\虚拟项目 I2C\\实验代码版本\\rkv_v2pro_i2c-RKV_I2C_TB_01\\rkv_i2c_tb',
...
if __name__ == '__main__':
    ...
    tree = DirectionTree(ignore_list=i_l, direction_path='D:\\Amaster\\A路科课程\\路科验证_V2课程资料\\虚拟项目 I2C\\实验代码版本\\rkv_v2pro_i2c-RKV_I2C_TB_01\\rkv_i2c_tb')
    print(tree.tree)
